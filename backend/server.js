...
const startServer = async () => {
  try {
     ...
     */
    app.get('/api/bookings/:vehicleId', async (req, res) => {
      try {
    ...
    /**
     * GET /api/vehicles
     * Get all available vehicles (admin endpoint)
     */
    ...
    app.listen(PORT, () => {
      ...
      console.log(`\n📊 Database: MongoDB (${process.env.MONGODB_URI || 'mongodb://localhost:27017/ev-test-drive'})`);
      console.log('\n');
    });
  } catch (error) {
